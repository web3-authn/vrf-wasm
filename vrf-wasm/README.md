...
# In your Cargo.toml
[dependencies]
vrf-wasm = { version = "0.4", features = ["browser"] }  # Default
# or
vrf-wasm = { version = "0.4", features = ["near"], default-features = false }
# or
vrf-wasm = { version = "0.4", features = ["native"], default-features = false }
```
